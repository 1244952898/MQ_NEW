...
namespace MQWebSite
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/css/menuCss", string.Format("{0}/css/menuCss.css", sourchPath)).Include("~/css/menuCss.css"));
            bundles.Add(new StyleBundle("~/css/publicmessage/PublicFileDetail", string.Format("{0}/css/publicmessage/PublicFileDetail.css", sourchPath)).Include("~/css/publicmessage/PublicFileDetail.css"));
